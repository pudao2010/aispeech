...
//        mAsrEngine.setServer("ws://s-test.api.aispeech.com:10000"); //灰度环境
        mAsrEngine.setServer(SampleConstants.SERVER_GRAY); //正式产品环境
        ...
        mAsrEngine.setPauseTime(600);
        mAsrEngine.setUseConf(true);
//       mAsrEngine.setVersion("aihome.0.15.2_0.14.13"); //设置资源的版本号
        mAsrEngine.setNoSpeechTimeOut(3000);
